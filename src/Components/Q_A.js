    ...
    < >
      <div >
        <div style={{ width: '100%' }}>
          ...
          <textarea name="Question" placeholder='Enter Your Answer here' id="YourQuestion" style={{ height: '50vh', width: '80vw', marginLeft: '10vw', backgroundColor: 'rgba(0,20,70,0.6)', borderRadius: '6px' }}></textarea>
        </div>
        <div style={{
          display: 'flex',
